...
public class PaymentsUtil {
    private static final int paymentsEnvironment = WalletConstants.ENVIRONMENT_TEST;
    private static final List<String> allowedCardNetworks = Arrays.asList(
            "AMEX",
            "DISCOVER",
            "JCB",
            "MASTERCARD",
            "VISA");
    private static final List<String> allowedCardAuthMethods = Arrays.asList(
            "PAN_ONLY",
            "CRYPTOGRAM_3DS");

    private static final String countryCode = "UK";
    private static final String currencyCode = "GBP";
    private static final String paymentGateway = "BigScreenCinema";
    private static final String merchantId = "BigScreenCinema";
    private static final String directTokenizationPublicKey = "REPLACE_ME";
    public static final HashMap<String,String> paymentGatewayParameters = new HashMap<String,String>() {{
        put("gateway", paymentGateway);
        put("gatewayMerchantId", merchantId);
    }};
    public static final HashMap<String,String> directTokenizationParameters = new HashMap<String,String>() {{
        put("protocolVersion", "ECv2");
        put("publicKey", directTokenizationPublicKey);
    }};
    private static final List<String> allowedShippingCountryCodes = Arrays.asList("GB", "US" );
    ...
    public static PaymentsClient createPaymentsClient(Context context) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(paymentsEnvironment).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        JSONObject parameters = new JSONObject(directTokenizationParameters);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(allowedCardNetworks);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(allowedCardAuthMethods);
    }
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(allowedShippingCountryCodes);
